...
case where durable checkpoints and gates start to matter more than the cycles do.

Deliberately unimplemented.  A stub that pretends to work is worse than one that says
what it would take -- and this module exists so the decision is recorded next to the
